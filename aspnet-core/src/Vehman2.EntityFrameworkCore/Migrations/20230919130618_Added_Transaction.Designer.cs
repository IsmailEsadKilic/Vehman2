...
{
    [DbContext(typeof(Vehman2DbContext))]
    [Migration("20230919130618_Added_Transaction")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vehman2.Brands.Brand", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Vehman2.CarModels.CarModel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Vehman2.Companies.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Vehman2.Fuels.Fuel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppFuels", (string)null);
                });

            modelBuilder.Entity("Vehman2.Owners.Owner", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Vehman2.Transactions.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Vehman2.Vehicles.Vehicle", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Vehman2.CarModels.CarModel", b =>
                {
                    b.HasOne("Vehman2.Brands.Brand", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Vehman2.Owners.Owner", b =>
                {
                    b.HasOne("Vehman2.Companies.Company", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Vehman2.Transactions.Transaction", b =>
                {
                    b.HasOne("Vehman2.Vehicles.Vehicle", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Vehman2.Vehicles.Vehicle", b =>
                {
                    b.HasOne("Vehman2.CarModels.CarModel", null)
                        .WithMany()
                        .HasForeignKey("CarModelId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Vehman2.Fuels.Fuel", null)
                        .WithMany()
                        .HasForeignKey("FuelId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Vehman2.Owners.Owner", null)
                        .WithMany()
